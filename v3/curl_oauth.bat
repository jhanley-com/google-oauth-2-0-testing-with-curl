...
@REM - There is a problem here in that the ID Token is too long for the Windows command line
echo "ID Token:"
@REM curl https://www.googleapis.com/oauth2/v3/tokeninfo?id_token=%ID_TOKEN%
@REM curl https://oauth2.googleapis.com/tokeninfo?id_token=%ID_TOKEN%
